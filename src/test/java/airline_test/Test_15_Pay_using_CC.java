...
import airline_source.Airline_CC_Payment;
...
public class Test_15_Pay_using_CC extends Airline_Launch_and_Quit
{
	@Test
	...
	/*	Airline_booking_Adult_traveller_details_page add_adults=new Airline_booking_Adult_traveller_details_page(driver);
		...
		Airline_CC_Payment cc_payment=new Airline_CC_Payment(driver);
		cc_payment.click_on_cc_dc_radio_button();
		cc_payment.enter_cc_number();
		cc_payment.select_month();
		cc_payment.select_year();
		Thread.sleep(3000);
		cc_payment.enter_card_details_button();
