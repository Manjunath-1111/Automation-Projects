...
import airline_source.Airline_MultiCity_Flight_Bookibg_Page;
...
public class Test_7_multi_city extends Airline_Launch_and_Quit
{
	@Test
	public void test1() throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		number_of_adults_childs_infats.select_child0();
		number_of_adults_childs_infats.select_infant0();
		...
		Airline_MultiCity_Flight_Bookibg_Page select_multicity=new Airline_MultiCity_Flight_Bookibg_Page(driver);
		select_multicity.select_city();
